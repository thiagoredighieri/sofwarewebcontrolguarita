                            ...
                            <div class="table-responsive">
                                <!--<table class="table table-striped table-bordered table-hover">-->
                                 ...
                                 <div class=" col-md-offset-7 col-md-5" >
                                    ...
                                    <form action="listaPassagemVisitante_P.php?pagina=1&itens=A&ordem=A&msg=" method="post">
                                   <div class="form-group input-group">
                                       <input type="text" class="form-control" placeholder="Nome do Visitante" name="nome">
                                ...
                                <div class="btn-group dropup">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" >
                                                <li><a href="listaPassagemVisitante.php?pagina=1&itens=A&ordem=A&msg=">10</a></li>
                                                <li><a href="listaPassagemVisitante.php?pagina=1&itens=B&ordem=A&msg=">20</a></li>
                                                <li><a href="listaPassagemVisitante.php?pagina=1&itens=C&ordem=A&msg=">50</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="btn-group dropup">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="listaPassagemVisitante.php?pagina=1&itens=A&ordem=A&msg=">Crescente</a></li>
                                                <li><a href="listaPassagemVisitante.php?pagina=1&itens=A&ordem=B&msg=">Descrecente</a></li>
