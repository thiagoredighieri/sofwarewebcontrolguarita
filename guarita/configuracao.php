...
$menu='
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Painel Guarita</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sign-in fa-fw"></i> Entrada<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="entradaVisitante.php?msg=">Visitantes</a>
                            </li>
                            <li>
                                <a href="entradacadastrado.php?msg=">Cadastado</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                        ...
                        <li>
                        <a href="#"><i class="fa fa-sign-out fa-fw"></i> Saída<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-paste fa-fw"></i> Relatorios<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="blank.html">Formulario 1</a>
                            </li>
                            <li>
                                <a href="login.html">Manual</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
