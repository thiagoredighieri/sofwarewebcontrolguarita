                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                             ...
                             <form class="valida"  action="cadastraPassagemResponsavel.php" method="post" onsubmit="return valida(this);">
               ...
               <fieldset>
                   <legend>Dados do Veículo</legend>
                    ...
                    <div class="col-lg-6" > 
                        ...
                        <div class="form-group">
                                            <label>NumCadatro</label>
                                            <input class="form-control" 
                                                    
                                                    required
                                                    name="txtnumcadastro"
                                                    value="<?php echo $veiculo->numcadastro; ?>"
                                                    data-validation-required-message="Preencha este campo">
                                                     <p class="help-block"></p>
                         </div>
